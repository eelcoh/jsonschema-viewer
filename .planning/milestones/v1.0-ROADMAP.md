...
- [x] **Phase 1: Foundation and Input** - Remove build blockers and wire up user-controlled schema input
- [x] **Phase 2: Correct Rendering** - Fix SVG viewport, $ref inline expansion, and required/optional distinction
- [x] **Phase 3: Expand/Collapse** - Make schema nodes interactively collapsible and expandable
- [x] **Phase 4: Visual Polish** - Add connector lines and distinct visual styles for $ref nodes
...
|-------|----------------|--------|-----------|
| 1. Foundation and Input | 2/2 | Complete | 2026-04-03 |
| 2. Correct Rendering | 2/2 | Complete | 2026-04-04 |
| 3. Expand/Collapse | 2/2 | Complete | 2026-04-05 |
